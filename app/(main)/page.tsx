    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden pb-16 md:pb-0">
          ...
          <div className="relative">
                ...
                >
                  ...
                  <div className="group relative h-[350px] md:h-[400px] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
                    ...
                    <div className="absolute top-3 md:top-4 left-3 md:left-4 right-3 md:right-4 flex items-start justify-between z-10">
                      {/* Type Badge */}
                      <div className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-600 rounded-full shadow-lg backdrop-blur-sm">
                      ...
                      <div className="w-14 h-14 md:w-16 md:h-16 bg-white rounded-full flex items-center justify-center shadow-2xl group-hover:rotate-12 transition-transform duration-300">
                        <div className="text-center">
                          <div className="text-base md:text-lg font-black text-teal-600 leading-tight">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 z-10">
                      {/* Icon */}
                      <div className="w-10 h-10 md:w-12 md:h-12 bg-teal-600 rounded-lg md:rounded-xl flex items-center justify-center shadow-lg mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <button className="absolute bottom-4 md:bottom-6 right-4 md:right-6 px-4 md:px-6 py-2 md:py-3 bg-white text-teal-600 font-bold text-sm md:text-base rounded-lg md:rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 flex items-center gap-1 md:gap-2 z-20 group/btn">
            ...
            <div className="flex justify-center gap-2 mt-4 md:mt-6">
              {promotions.map((_, index) => (
                <div
                  key={index}
                  className="w-2 h-2 rounded-full bg-teal-300 hover:bg-teal-500 transition-colors cursor-pointer"
                />
              ))}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="group relative">
                <div className="relative bg-teal-50 rounded-2xl p-8 text-center transition-all duration-300 group-hover:translate-y-[-4px]">
                  <div className="text-teal-600 mb-4 flex justify-center group-hover:scale-110 transition-transform">{stat.icon}</div>
                  <div className="text-4xl font-black text-teal-600 mb-2">{stat.number}</div>
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 relative bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-black mb-4 text-teal-600">
                ...
                >
                  <div className="relative rounded-2xl transition-all duration-300">
                    <div className="relative bg-white rounded-2xl p-8 h-full space-y-4 transition-all duration-300">
                      <div className="w-16 h-16 rounded-2xl bg-teal-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                        {service.icon}
                      </div>
                      ...
                      <Link href="/services">
                        <Button className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold transition-all">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 relative bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-teal-50 text-teal-600 px-4 py-2">
            ...
            {[
              ...
              <div key={index} className="flex gap-8 items-start group">
                <div className="flex flex-col items-center">
                  <div className="relative">
                    <div className="relative w-20 h-20 rounded-full bg-teal-500 flex items-center justify-center text-2xl font-black text-white group-hover:scale-110 transition-transform">
                      {item.step}
                    </div>
                  </div>
                  {index < 2 && (
                    <div className="w-1 h-24 bg-teal-500 mt-4 rounded-full" />
                  )}
                </div>
                <div className="pt-4 flex-1 bg-teal-50 rounded-2xl p-6 transition-all duration-300">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 relative bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-white text-teal-600 px-4 py-2">
              <Star className="h-4 w-4 mr-2 fill-teal-600" />
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="group">
                <div className="relative bg-white rounded-2xl p-8 transition-all duration-300 h-full">
                  <div className="absolute top-6 right-6 text-6xl opacity-10 text-teal-500">"</div>
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full bg-teal-500 flex items-center justify-center text-3xl mb-4">
                      {testimonial.image}
                    </div>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="group">
                <button
                  ...
                  className="w-full px-6 py-5 bg-teal-50 rounded-2xl flex items-center justify-between transition-all duration-300"
                >
                  <span className="font-bold text-gray-900 text-left text-lg"><TranslatedText text={faq.question} /></span>
                  <div className="w-10 h-10 rounded-full bg-teal-500 flex items-center justify-center flex-shrink-0 ml-4">
