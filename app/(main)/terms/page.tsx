                ...
                <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-xl shadow-slate-100 border border-slate-50 relative">
                    <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-8">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 mt-4 space-y-2">
                                <li><strong>Payments</strong> are collected by Neere Business Group Ltd and processed securely through our payment partner, <strong>FDI Payments</strong>. Accepted methods include MTN Mobile Money and Airtel Money. All payments are subject to verification.</li>
