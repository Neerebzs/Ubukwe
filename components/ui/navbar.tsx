      ...
      <header className="w-full bg-white backdrop-blur-sm z-50 top-0 fixed">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            <div className="h-10 w-10 rounded-full bg-teal-500 flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-lg">V</span>
            </div>
            <span className="text-xl font-bold text-gray-900">VowNest</span>
            <Badge className="text-xs hidden sm:inline-flex bg-teal-100 text-teal-600 border-teal-200">
              Rwanda
            </Badge>
          </Link>
          ...
          {isMobile === false && (
            <div className="hidden md:flex items-center space-x-6">
              <nav className="flex space-x-6 items-center">
                <a href="/" className="text-gray-900 hover:text-teal-600 transition-colors font-medium">
                  <TranslatedText text="Home" />
                </a>
                <a href="/services" className="text-gray-900 hover:text-teal-600 transition-colors font-medium">
                  <TranslatedText text="Services" />
                </a>
                <a href="/events" className="text-gray-900 hover:text-teal-600 transition-colors font-medium">
                  <TranslatedText text="Events" />
                </a>
                <a href="/about" className="text-gray-900 hover:text-teal-600 transition-colors font-medium">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="pt-4 border-t border-teal-200">
                <div className="px-4 py-2">
                  <p className="text-xs text-teal-600 mb-2 uppercase tracking-wider font-semibold">Language</p>
                  <LanguageSwitcher />
                </div>
              </div>
