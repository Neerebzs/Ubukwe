...
import { ChevronLeft, ChevronDown, ChevronRight, Home, CheckCircle, Star, BookOpen, DollarSign, MessageCircle, Users, Heart, FileText, ShieldAlert, LogOut, Sparkles, Globe } from "lucide-react";
        ...
        <div className="p-8 pb-10 border-b border-white/5 flex items-center justify-between flex-shrink-0">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-black text-[#668c65] uppercase tracking-[0.3em]">Customer Sanctuary</p>
            </div>
          </div>
          <Button
            variant="ghost"
